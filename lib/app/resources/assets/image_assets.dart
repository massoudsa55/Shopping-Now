const String baseImages = "assets/images";

class ImageAssets {
  static String splashLogo = "$baseImages/splash_logo.png";
  static String onBoardingLogo1 = "$baseImages/logo_onboarding1.svg";
  ...
  static String splashScreenLogo = "$baseImages/splash_screen.json";
}
